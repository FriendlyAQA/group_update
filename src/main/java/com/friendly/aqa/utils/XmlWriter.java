...
public class XmlWriter {
    ...
    public static void createImportGroupFile() {
        ...
        sb.append("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n").append("<Update>\n").append("\t<Name>imported_group</Name>\n")
                ...
                .append("\t</ProductGroupValue>\n").append("\t<Tasks>\n").append("\t\t<TaskSetParam>\n").append("\t\t\t<Params>\n")
                .append("\t\t\t\t<Param fullname=\"InternetGatewayDevice.ManagementServer.PeriodicInformInterval\" value=\"60\"/>\n")
                .append("\t\t\t</Params>\n").append("\t\t</TaskSetParam>\n").append("\t</Tasks>\n").append("\t<ScheduledDate/>\n")
                .append("\t<ActivateDate>01/20/2020 15:12:13</ActivateDate>\n").append("\t<Period1>- /0/0</Period1>\n")
